...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/opt/gridpro/python/bin',
 'BINLIBDEST': '/opt/gridpro/python/lib/python3.11',
 'BLDLIBRARY': '-L. -lpython3.11',
 'BLDSHARED': 'gcc -pthread -shared -lffi   -L/usr/lib64/openssl11 -lssl '
              "-lcrypto   -Wl,-rpath,'1ORIGIN/../lib' -lffi   "
              '-L/usr/lib64/openssl11 -lssl -lcrypto   '
              "-Wl,-rpath,'1ORIGIN/../lib'",
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-fno-semantic-interposition -std=c11 -Wextra '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/usr/include/openssl11',
 'CONFIGURE_LDFLAGS': '-lffi   -L/usr/lib64/openssl11 -lssl -lcrypto   '
                      "-Wl,-rpath,'1ORIGIN/../lib'",
 'CONFIGURE_LDFLAGS_NODIST': '-fno-semantic-interposition',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--prefix=/opt/gridpro/python' '--enable-optimizations' "
                "'--with-openssl=/usr/include/openssl11' '--with-system-ffi' "
                "'--enable-shared' 'PKG_CONFIG_PATH=/usr/local/lib/pkgconfig' "
                "'LDFLAGS=-lffi   -L/usr/lib64/openssl11 -lssl -lcrypto   "
                "-Wl,-rpath,'\\''1ORIGIN/../lib'\\''' 'CPPFLAGS=  "
                "-I/usr/include/openssl11  '",
 'CONFINCLUDEDIR': '/opt/gridpro/python/include',
 'CONFINCLUDEPY': '/opt/gridpro/python/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/io/Python-3.11.14/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/io/Python-3.11.14/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage '
                            '--title "CPython 3.11 LCOV report [commit $(shell '
                            ')]"',
 'CPPFLAGS': '-I. -I./Include -I/usr/include/openssl11   '
             '-I/usr/include/openssl11',
 'CXX': 'g++ -pthread',
 ...
 'DESTDIRS': '/opt/gridpro/python /opt/gridpro/python/lib '
             '/opt/gridpro/python/lib/python3.11 '
             '/opt/gridpro/python/lib/python3.11/lib-dynload',
 'DESTLIB': '/opt/gridpro/python/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/opt/gridpro/python/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/opt/gridpro/python/include /opt/gridpro/python/include '
                   '/opt/gridpro/python/include/python3.11 '
                   '/opt/gridpro/python/include/python3.11',
 'INCLUDEDIR': '/opt/gridpro/python/include',
 'INCLUDEPY': '/opt/gridpro/python/include/python3.11',
 ...
 'LDFLAGS': '-lffi   -L/usr/lib64/openssl11 -lssl -lcrypto   '
            "-Wl,-rpath,'1ORIGIN/../lib' -lffi   -L/usr/lib64/openssl11 -lssl "
            "-lcrypto   -Wl,-rpath,'1ORIGIN/../lib'",
 'LDLIBRARY': 'libpython3.11.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -lffi   -L/usr/lib64/openssl11 -lssl '
             "-lcrypto   -Wl,-rpath,'1ORIGIN/../lib' -lffi   "
             '-L/usr/lib64/openssl11 -lssl -lcrypto   '
             "-Wl,-rpath,'1ORIGIN/../lib'",
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/opt/gridpro/python/lib/python3.11',
 'LIBDIR': '/opt/gridpro/python/lib',
 ...
 'LIBEXPAT_CFLAGS': '-I./Modules/expat -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                    ...
                    '-I. -I./Include -I/usr/include/openssl11   '
                    '-I/usr/include/openssl11 -fPIC -fPIC',
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/opt/gridpro/python/lib/pkgconfig',
 'LIBPL': '/opt/gridpro/python/lib/python3.11/config-3.11-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/gridpro/python/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/opt/gridpro/python/share/man',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
                             ...
                             '-I./Include -I/usr/include/openssl11   '
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
                   ...
                   '-fprofile-use -fprofile-correction -I./Include/internal '
                   '-I. -I./Include -I/usr/include/openssl11   '
                   '-I/usr/include/openssl11 -fPIC -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-lffi   -L/usr/lib64/openssl11 -lssl -lcrypto   '
                    "-Wl,-rpath,'1ORIGIN/../lib' -lffi   "
                    '-L/usr/lib64/openssl11 -lssl -lcrypto   '
                    "-Wl,-rpath,'1ORIGIN/../lib' -fno-semantic-interposition",
 'PY_CPPFLAGS': '-I. -I./Include -I/usr/include/openssl11   '
                '-I/usr/include/openssl11',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-lffi   -L/usr/lib64/openssl11 -lssl -lcrypto   '
               "-Wl,-rpath,'1ORIGIN/../lib' -lffi   -L/usr/lib64/openssl11 "
               "-lssl -lcrypto   -Wl,-rpath,'1ORIGIN/../lib'",
 'PY_LDFLAGS_NODIST': '-fno-semantic-interposition',
 'PY_LDFLAGS_NOLTO': '-lffi   -L/usr/lib64/openssl11 -lssl -lcrypto   '
                     "-Wl,-rpath,'1ORIGIN/../lib' -lffi   "
                     '-L/usr/lib64/openssl11 -lssl -lcrypto   '
                     "-Wl,-rpath,'1ORIGIN/../lib'",
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/io/Python-3.11.14:/opt/rh/devtoolset-10/root/usr/lib64:/opt/rh/devtoolset-10/root/usr/lib:/opt/rh/devtoolset-10/root/usr/lib64/dyninst:/opt/rh/devtoolset-10/root/usr/lib/dyninst:/usr/local/lib64',
 'SCRIPTDIR': '/opt/gridpro/python/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/io/Python-3.11.14:/opt/rh/devtoolset-10/root/usr/lib64:/opt/rh/devtoolset-10/root/usr/lib:/opt/rh/devtoolset-10/root/usr/lib64/dyninst:/opt/rh/devtoolset-10/root/usr/lib/dyninst:/usr/local/lib64 '
               './python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/io/Python-3.11.14:/opt/rh/devtoolset-10/root/usr/lib64:/opt/rh/devtoolset-10/root/usr/lib:/opt/rh/devtoolset-10/root/usr/lib64/dyninst:/opt/rh/devtoolset-10/root/usr/lib/dyninst:/usr/local/lib64 '
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './opt/gridpro/python',
 'WASM_STDLIB': './opt/gridpro/python/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 0,
 ...
 'abs_builddir': '/io/Python-3.11.14',
 'abs_srcdir': '/io/Python-3.11.14',
 'datarootdir': '/opt/gridpro/python/share',
 'exec_prefix': '/opt/gridpro/python',
 'prefix': '/opt/gridpro/python',
 'srcdir': '.'}
